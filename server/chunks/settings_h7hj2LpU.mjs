...
import { u as useOutsideClick, g as useKeydown, B as httpDelete, p as pageProgressMessage, S as Spinner, w as httpPut, h as httpGet } from './BaseLayout_CyQdLUYI.mjs';
import { U as UploadProfilePicture } from './UploadProfilePicture_C8TU1c7H.mjs';
import { u as useTeamId, a as $isCurrentTeamAdmin } from './TeamDropdown_CxJZJkhn.mjs';
...
function DeleteTeamPopup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpDelete(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-delete-team/${teamId}`
    );
    if (error2 || !response) {
      setIsLoading(false);
...
function UpdateTeamForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error } = await httpPut(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-update-team/${teamId}`,
      {
        name,
        website,
        type: teamType,
  ...
  async function loadTeam() {
    const { response, error } = await httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-get-team/${teamId}`
    );
    if (error || !response) {
      console.log(error);
      return;
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-4 flex h-[42px] w-full items-center rounded-lg border border-gray-300 px-3 py-2 shadow-sm", children: /* @__PURE__ */ jsxs(
        "label",
        {
...
const $$Settings = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AccountLayout", $$AccountLayout, { "title": "Team Settings", "noIndex": true, "initialLoadingMessage": "Loading Settings" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TeamSidebar", TeamSidebar, { "activePageId": "settings", "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/TeamSidebar", "client:component-export": "TeamSidebar" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "UpdateTeamForm", UpdateTeamForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/TeamSettings/UpdateTeamForm", "client:component-export": "UpdateTeamForm" })} ` })} ` })}`;
}, "/workspaces/developer-roadmap/src/pages/team/settings.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/team/settings.astro";
