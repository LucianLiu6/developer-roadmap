...
function SkeletonRoadmapHeader() {
  return /* @__PURE__ */ jsx("div", { className: "border-b", children: /* @__PURE__ */ jsxs("div", { className: "container relative py-5 sm:py-12", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsx("div", { className: "h-4 w-4 animate-pulse rounded-full bg-gray-300" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2 sm:gap-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "h-7 w-[60.52px] animate-pulse rounded-md bg-gray-300 sm:h-8 sm:w-[139.71px]" }),
        /* @__PURE__ */ jsx("div", { className: "h-7 w-[71.48px] animate-pulse rounded-md bg-gray-300 sm:h-8 sm:w-[100.34px]" }),
        /* @__PURE__ */ jsx("div", { className: "h-7 w-[32px] animate-pulse rounded-md bg-gray-300 sm:h-8 sm:w-[89.73px]" })
      ] })
    ] }),
