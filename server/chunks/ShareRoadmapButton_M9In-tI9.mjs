...
import { c as cn, u as useOutsideClick } from './BaseLayout_CyQdLUYI.mjs';
...
function ShareRoadmapButton(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", ref: containerRef, children: [
    ...
    isDropdownOpen && /* @__PURE__ */ jsx("div", { className: "absolute left-0 z-[999] mt-1 w-48 rounded-md bg-slate-800 text-sm text-white shadow-lg ring-1 ring-black ring-opacity-5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col px-1 py-1", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => {
      ...
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "flex w-[20px] items-center justify-center", children: /* @__PURE__ */ jsx(TwitterIcon, { className: "h-[16px] text-slate-400" }) }),
            "Twitter"
          ]
        }
      ),
