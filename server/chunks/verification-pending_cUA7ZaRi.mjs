...
function VerificationEmailMessage() {
  ...
  const resendVerificationEmail = () => {
    httpPost(`${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-send-verification-email`, {
      email
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md text-center", children: [
    /* @__PURE__ */ jsx(VerifyLetterIcon, { className: "mx-auto mb-4 h-20 w-40 sm:h-40" }),
    /* @__PURE__ */ jsx("h2", { className: "my-2 text-center text-xl font-semibold sm:my-5 sm:text-2xl", children: "Verify your email address" }),
    /* @__PURE__ */ jsxs("div", { className: "text-sm sm:text-base", children: [
      /* @__PURE__ */ jsxs("p", { children: [
        ...
        ". Please click the link to verify your account. This link will expire shortly, so please verify soon!"
      ] }),
      /* @__PURE__ */ jsx("hr", { className: "my-4" }),
      !isEmailResent && /* @__PURE__ */ jsxs(Fragment, { children: [
        isLoading && /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "Sending the email .." }),
      ...
      isEmailResent && /* @__PURE__ */ jsx("p", { className: "text-green-700", children: "Verification email has been sent!" })
    ] })
  ] });
}

const $$VerificationPending = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AccountLayout", $$AccountLayout, { "title": "Verify Email", "noIndex": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="container py-8 sm:py-20"> ${renderComponent($$result2, "VerificationEmailMessage", VerificationEmailMessage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/AuthenticationFlow/VerificationEmailMessage", "client:component-export": "VerificationEmailMessage" })} </section> ` })}`;
}, "/workspaces/developer-roadmap/src/pages/verification-pending.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/verification-pending.astro";
const $$url = "/verification-pending";

export { $$VerificationPending as default, $$file as file, $$url as url };
