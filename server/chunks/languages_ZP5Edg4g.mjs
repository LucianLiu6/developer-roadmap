...
}, "/workspaces/developer-roadmap/src/pages/frontend/languages.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/frontend/languages.astro";
const $$url = "/frontend/languages";
