...
import { e as $$Popup, c as cn, p as pageProgressMessage, b as httpPatch, f as httpPost, h as httpGet } from './BaseLayout_CyQdLUYI.mjs';
...
</p> <p class="text-black font-medium -mb-2 mt-3 text-base">Please type "delete" to confirm.</p> ${renderComponent($$result2, "DeleteAccountForm", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/workspaces/developer-roadmap/src/components/DeleteAccount/DeleteAccountForm", "client:component-export": "DeleteAccountForm" })} </div> ` })}`;
}, "/workspaces/developer-roadmap/src/components/DeleteAccount/DeleteAccountPopup.astro", void 0);
...
</p> <button data-popup="delete-account-popup" class="mt-4 w-full rounded-lg bg-red-600 py-2 text-base font-regular text-white outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1">
Delete Account
</button>`;
}, "/workspaces/developer-roadmap/src/components/DeleteAccount/DeleteAccount.astro", void 0);
...
function UpdateEmailForm(props) {
  ...
  const handleSentVerificationCode = async (e) => {
    ...
    const { response, error } = await httpPatch(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-update-user-email`,
      { email: newEmail }
    );
    if (error || !response) {
  ...
  const handleResendVerificationCode = async () => {
    ...
    const { response, error } = await httpPatch(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-resend-email-verification-code`,
      { email: newEmail }
    );
    if (error || !response) {
      toast.error(error?.message || "Something went wrong");
  ...
  const handleCancelEmailVerification = async () => {
    ...
    const { response, error } = await httpPatch(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-cancel-email-verification`,
      {}
    );
    if (error || !response) {
      toast.error(error?.message || "Something went wrong");
...
function UpdatePasswordForm(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error } = await httpPost(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-update-password`,
      {
...
function ProfileSettingsPage() {
  ...
  const loadProfile = async () => {
    const { error, response } = await httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-me`
    );
    if (error || !response) {
      toast.error(error?.message || "Something went wrong");
      return;
...
const $$Settings = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AccountLayout", $$AccountLayout, { "title": "Settings", "description": "", "noIndex": true, "initialLoadingMessage": "Loading settings" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AccountSidebar", $$AccountSidebar, { "activePageId": "settings", "activePageTitle": "Settings" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "ProfileSettingsPage", ProfileSettingsPage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/ProfileSettings/ProfileSettingsPage", "client:component-export": "ProfileSettingsPage" })} ${maybeRenderHead()}<hr class="my-8"> ${renderComponent($$result3, "DeleteAccount", $$DeleteAccount, {})} ` })} ` })}`;
}, "/workspaces/developer-roadmap/src/pages/account/settings.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/account/settings.astro";
