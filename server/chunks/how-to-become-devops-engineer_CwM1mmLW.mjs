...
const $$HowToBecomeDevopsEngineer = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspaces/developer-roadmap/src/pages/devops/how-to-become-devops-engineer.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/devops/how-to-become-devops-engineer.astro";
const $$url = "/devops/how-to-become-devops-engineer";

export { $$HowToBecomeDevopsEngineer as default, $$file as file, $$url as url };
