import { k as createAstro, l as createComponent, m as renderTemplate, n as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, o as addAttribute, p as renderComponent, t as renderSlot, v as renderHead } from './astro/server_DJHfVkFr.mjs';
import 'kleur/colors';
...
import { Menu, Waypoints, CheckSquare, FileQuestion, BookOpenText, Video, Shirt, X } from 'lucide-react';
...
const $$AstroIcon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  async function getSVG(name) {
    ...
    const files = /* #__PURE__ */ Object.assign({"/src/icons/accept.svg": __vite_glob_0_0,"/src/icons/analytics.svg": __vite_glob_0_1,"/src/icons/badge.svg": __vite_glob_0_2,"/src/icons/bell.svg": __vite_glob_0_3,"/src/icons/best-practices.svg": __vite_glob_0_4,"/src/icons/building.svg": __vite_glob_0_5,"/src/icons/bulb.svg": __vite_glob_0_6,"/src/icons/chat.svg": __vite_glob_0_7,"/src/icons/check-current.svg": __vite_glob_0_8,"/src/icons/check.svg": __vite_glob_0_9,"/src/icons/chevron-down.svg": __vite_glob_0_10,"/src/icons/clipboard.svg": __vite_glob_0_11,"/src/icons/close-dark.svg": __vite_glob_0_12,"/src/icons/close.svg": __vite_glob_0_13,"/src/icons/cog.svg": __vite_glob_0_14,"/src/icons/comment.svg": __vite_glob_0_15,"/src/icons/construction.svg": __vite_glob_0_16,"/src/icons/copy.svg": __vite_glob_0_17,"/src/icons/discord.svg": __vite_glob_0_18,"/src/icons/down.svg": __vite_glob_0_19,"/src/icons/download.svg": __vite_glob_0_20,"/src/icons/dropdown.svg": __vite_glob_0_21,"/src/icons/email.svg": __vite_glob_0_22,"/src/icons/error.svg": __vite_glob_0_23,"/src/icons/external-link.svg": __vite_glob_0_24,"/src/icons/facebook.svg": __vite_glob_0_25,"/src/icons/github.svg": __vite_glob_0_26,"/src/icons/globe.svg": __vite_glob_0_27,"/src/icons/google.svg": __vite_glob_0_28,"/src/icons/group.svg": __vite_glob_0_29,"/src/icons/guide.svg": __vite_glob_0_30,"/src/icons/hackernews.svg": __vite_glob_0_31,"/src/icons/hamburger.svg": __vite_glob_0_32,"/src/icons/home.svg": __vite_glob_0_33,"/src/icons/letter.svg": __vite_glob_0_34,"/src/icons/linkedin-2.svg": __vite_glob_0_35,"/src/icons/linkedin.svg": __vite_glob_0_36,"/src/icons/logo.svg": __vite_glob_0_37,"/src/icons/map.svg": __vite_glob_0_38,"/src/icons/more-vertical.svg": __vite_glob_0_39,"/src/icons/notification.svg": __vite_glob_0_40,"/src/icons/plus.svg": __vite_glob_0_41,"/src/icons/progress.svg": __vite_glob_0_42,"/src/icons/question.svg": __vite_glob_0_43,"/src/icons/reddit.svg": __vite_glob_0_44,"/src/icons/reset.svg": __vite_glob_0_45,"/src/icons/roadmap.svg": __vite_glob_0_46,"/src/icons/search.svg": __vite_glob_0_47,"/src/icons/security.svg": __vite_glob_0_48,"/src/icons/skip.svg": __vite_glob_0_49,"/src/icons/spinner.svg": __vite_glob_0_50,"/src/icons/star.svg": __vite_glob_0_51,"/src/icons/team-progress.svg": __vite_glob_0_52,"/src/icons/twitter-fill.svg": __vite_glob_0_53,"/src/icons/twitter.svg": __vite_glob_0_54,"/src/icons/user-plus.svg": __vite_glob_0_55,"/src/icons/user.svg": __vite_glob_0_56,"/src/icons/users.svg": __vite_glob_0_57,"/src/icons/verify-letter.svg": __vite_glob_0_58,"/src/icons/video.svg": __vite_glob_0_59,"/src/icons/youtube.svg": __vite_glob_0_60
...
}, "/workspaces/developer-roadmap/src/components/AstroIcon.astro", void 0);
...
const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$1 || (_a$1 = __template$1([` <script async src="https://www.googletagmanager.com/gtag/js?id=UA-139582634-1"><\/script> <script>
  // @ts-nocheck
...
<\/script>`])));
}, "/workspaces/developer-roadmap/src/components/Analytics/Analytics.astro", void 0);
...
function setViewSponsorCookie(sponsorId) {
...
function GitHubButton(props) {
  ...
  useEffect(() => {
    ...
    setIsDisabled?.(true);
    httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-github-callback${window.location.search}`
  ...
  const handleClick = async () => {
    ...
    const { response, error: error2 } = await httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-github-login`
    );
...
function GoogleButton(props) {
  ...
  useEffect(() => {
    ...
    setIsDisabled?.(true);
    httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-google-callback${window.location.search}`
    ).then(({ response, error: error2 }) => {
      if (!response?.token) {
  ...
  const handleClick = () => {
    ...
    setIsDisabled?.(true);
    httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-google-login`
    ).then(({ response, error: error2 }) => {
...
function LinkedInIcon(props) {
  ...
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      height: "100",
      viewBox: "0,0,256,256",
      children: /* @__PURE__ */ jsx("g", { transform: "translate(-26.66667,-26.66667) scale(1.20833,1.20833)", children: /* @__PURE__ */ jsx(
        "g",
        {
          fill: "none",
          fillRule: "nonzero",
          ...
          children: /* @__PURE__ */ jsxs("g", { transform: "scale(5.33333,5.33333)", children: [
            /* @__PURE__ */ jsx(
              "path",
              {
...
function LinkedInButton(props) {
  ...
  useEffect(() => {
    ...
    setIsDisabled?.(true);
    httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-linkedin-callback${window.location.search}`
    ).then(({ response, error: error2 }) => {
      if (!response?.token) {
        setError(error2?.message || "Something went wrong.");
        setIsLoading(false);
  ...
  const handleClick = () => {
    ...
    setIsDisabled?.(true);
    httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-linkedin-login`
    ).then(({ response, error: error2 }) => {
      if (!response?.loginUrl) {
        setError(error2?.message || "Something went wrong.");
        setIsLoading(false);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        onClick: handleClick,
        children: [
          isLoading ? /* @__PURE__ */ jsx(Spinner, { className: "h-[18px] w-[18px]", isDualRing: false }) : /* @__PURE__ */ jsx(LinkedInIcon, { className: "h-[18px] w-[18px]" }),
...
function EmailLoginForm(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpPost(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-login`,
      {
        email,
        password
      }
  ...
  return /* @__PURE__ */ jsxs("form", { className: "w-full", onSubmit: handleFormSubmit, children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mb-3 mt-2 text-sm text-gray-500", children: /* @__PURE__ */ jsx(
      "a",
      {
...
function EmailSignupForm(props) {
  ...
  const onSubmit = async (e) => {
    ...
    setError("");
    const { response, error: error2 } = await httpPost(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-register`,
      {
        email,
        password,
        name
...
const $$LoginPopup = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Popup", $$Popup, { "id": "login-popup", "title": "", "subtitle": "" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mb-7 text-center"> <p class="mb-3 text-2xl font-semibold leading-5 text-slate-900">
...
}, "/workspaces/developer-roadmap/src/components/AuthenticationFlow/LoginPopup.astro", void 0);

const $$Authenticator = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate``;
}, "/workspaces/developer-roadmap/src/components/Authenticator/Authenticator.astro", void 0);
...
&copy; roadmap.sh
<span class="mx-1.5">&middot;</span> <a href="/terms" class="hover:text-white">Terms</a> <span class="mx-1.5">&middot;</span> <a href="/privacy" class="hover:text-white">Privacy</a> <span class="mx-1.5">&middot;</span> <a aria-label="Write us an email" href="mailto:info@roadmap.sh" class="hover:text-white"> ${renderComponent($$result, "AstroIcon", $$AstroIcon, { "icon": "letter", "class": "inline-block h-5 w-5" })} </a> <a aria-label="Subscribe to YouTube channel" href="https://youtube.com/theroadmap?sub_confirmation=1" target="_blank" class="ml-2 hover:text-white"> ${renderComponent($$result, "AstroIcon", $$AstroIcon, { "icon": "youtube", "class": "inline-block h-5 w-5" })} </a> <a aria-label="Follow on Twitter" href="https://twitter.com/roadmapsh" target="_blank" class="ml-2 hover:text-white"> ${renderComponent($$result, "AstroIcon", $$AstroIcon, { "icon": "twitter-fill", "class": "inline-block h-5 w-5 fill-current" })} </a> </p> </div> </div> <div class="max-w-[365px] text-left sm:text-right"> <a href="https://thenewstack.io" target="_blank"> <img src="/images/tns-sm.png" alt="ThewNewStack" class="my-1.5 mr-auto sm:ml-auto sm:mr-0" width="200" height="24.8" loading="lazy"> </a> <p class="my-4 text-slate-300/60">
          ...
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsx("span", { className: "font-medium text-slate-300 transition-colors group-hover:text-slate-100", children: link.label }),
...
const $$Navigation = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="bg-slate-900 py-5 text-white sm:py-8"> <nav class="container flex items-center justify-between"> <div class="flex items-center gap-5"> <a class="flex items-center text-lg font-medium text-white" href="/" aria-label="roadmap.sh"> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "logo" })} </a> <a href="/teams" class="group inline sm:hidden relative !mr-2 text-blue-300 hover:text-white">
Teams
<span class="absolute -right-[11px] top-0"> <span class="relative flex h-2 w-2"> <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-sky-400 opacity-75"></span> <span class="relative inline-flex h-2 w-2 rounded-full bg-sky-500"></span> </span> </span> </a> <!-- Desktop navigation items --> <div class="hidden space-x-5 sm:flex sm:items-center"> ${renderComponent($$result, "NavigationDropdown", NavigationDropdown, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/NavigationDropdown", "client:component-export": "NavigationDropdown" })} <a href="/get-started" class="text-gray-400 hover:text-white">
Start Here
</a> <a href="/teams" class="group relative !mr-2 text-blue-300 hover:text-white">
Teams
<span class="absolute -right-[11px] top-0"> <span class="relative flex h-2 w-2"> <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-sky-400 opacity-75"></span> <span class="relative inline-flex h-2 w-2 rounded-full bg-sky-500"></span> </span> </span> </a> <a href="/ai" class="text-gray-400 hover:text-white"> AI Roadmaps</a> <button data-command-menu class="hidden items-center rounded-md border border-gray-800 px-2.5 py-1.5 text-sm text-gray-400 hover:cursor-pointer hover:bg-gray-800 md:flex"> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "search", "class": "h-3 w-3" })} <span class="ml-2">Search</span> </button> </div> </div> <ul class="hidden h-8 w-[172px] items-center justify-end gap-5 sm:flex"> <li data-guest-required class="hidden"> <a href="/login" class="text-gray-400 hover:text-white">Login</a> </li> <li> ${renderComponent($$result, "AccountDropdown", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/workspaces/developer-roadmap/src/components/Navigation/AccountDropdown", "client:component-export": "AccountDropdown" })} <a data-guest-required class="flex hidden h-8 w-28 cursor-pointer items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-700 px-4 py-2 text-sm font-medium text-white hover:from-blue-500 hover:to-blue-600" href="/signup"> <span>Sign Up</span> </a> </li> </ul> <!-- Mobile Navigation Button --> <button class="block cursor-pointer text-gray-400 hover:text-gray-50 sm:hidden" aria-label="Menu" data-show-mobile-nav> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "hamburger" })} </button> <!-- Mobile Navigation Items --> <div class="fixed bottom-0 left-0 right-0 top-0 z-40 flex hidden items-center bg-slate-900" data-mobile-nav> <button data-close-mobile-nav class="absolute right-6 top-6 block cursor-pointer text-gray-400 hover:text-gray-50" aria-label="Close Menu"> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "close" })} </button> <ul class="flex w-full flex-col items-center gap-2 md:gap-3"> <li> <a href="/roadmaps" class="text-xl hover:text-blue-300 md:text-lg">
Roadmaps
</a> </li> <li> <a href="/best-practices" class="text-xl hover:text-blue-300 md:text-lg">
Best Practices
</a> </li> <li> <a href="/guides" class="text-xl hover:text-blue-300 md:text-lg">
Guides
</a> </li> <li> <a href="/videos" class="text-xl hover:text-blue-300 md:text-lg">
Videos
...
Account
</a> </li> <li data-auth-required class="hidden"> <a href="/team" class="text-xl hover:text-blue-300 md:text-lg">
Teams
...
}, "/workspaces/developer-roadmap/src/components/Navigation/Navigation.astro", void 0);
...
const $$OpenSourceStat = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex items-start sm:items-center justify-start flex-col sm:justify-center sm:gap-0 gap-2 sm:bg-transparent sm:rounded-none rounded-xl p-0 sm:p-4 mb-3 sm:mb-0"> ${isGitHubStars && renderTemplate`<p class="flex items-center text-sm text-blue-500 sm:flex"> <span class="rounded-md bg-blue-500 px-1 text-white">Rank 6th</span>
&nbsp;out of 28M!
</p>`} ${isRegistered && renderTemplate`<p class="flex items-center text-sm text-blue-500 sm:flex"> <span class="mr-1.5 rounded-md bg-blue-500 px-1 text-white">+75k</span>
every month
</p>`} ${isDiscordMembers && renderTemplate`<p class="flex items-center text-sm text-blue-500 sm:flex"> <span class="mr-1.5 rounded-md bg-blue-500 px-1 text-white">+1.5k</span>
every month
</p>`} <div class="flex flex-row items-center sm:flex-col my-1 sm:my-0"> <p class="relative my-0 sm:my-4 mr-1 sm:mr-0 text-base font-bold sm:w-auto sm:text-5xl"> ${value} </p> <p class="mb-0 mt-0 text-base sm:text-xs tracking-wide text-black sm:-mt-3 sm:mb-5"> ${text} </p> </div> ${isGitHubStars && renderTemplate`<a href="https://github.com/kamranahmedse/developer-roadmap" target="_blank" class="group mt-0 flex flex-col items-center rounded-lg border border-black bg-white px-3 py-2 text-sm hover:bg-black hover:text-white"> <div class="mb-0.5 flex items-center font-semibold"> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "star", "class": "-ml-1 fill-current" })} <span class="ml-1.5 hover:block">Star us on GitHub</span> </div> <span class="text-xs text-gray-500 group-hover:text-gray-100">
Help us reach #1
...
</span> </a>`} ${isDiscordMembers && renderTemplate`<a href="https://discord.gg/cJpEt5Qbwa" target="_blank" class="group mt-0 flex flex-col items-center rounded-lg border border-black bg-white px-3 py-2 text-sm hover:bg-black hover:text-white"> <div class="mb-0.5 flex items-center font-semibold"> ${renderComponent($$result, "Icon", $$AstroIcon, { "icon": "discord", "class": "-ml-1 h-[13px] fill-current" })} <span class="ml-1 hover:block">Join on Discord</span> </div> <span class="text-xs text-gray-500 group-hover:text-gray-100">
Join the community
</span> </a>`} </div>`;
}, "/workspaces/developer-roadmap/src/components/OpenSourceStat.astro", void 0);

const $$Astro$1 = createAstro("https://roadmap.sh/");
const $$OpenSourceBanner = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$OpenSourceBanner;
...
</p> <div class="mt-5 grid grid-cols-1 justify-between gap-2 divide-x-0 sm:my-11 sm:grid-cols-3 sm:gap-0 sm:divide-x mb-4 sm:mb-0"> ${renderComponent($$result, "OpenSourceStat", $$OpenSourceStat, { "text": "GitHub Stars", "value": starCount })} ${renderComponent($$result, "OpenSourceStat", $$OpenSourceStat, { "text": "Registered Users", "value": "+1M" })} ${renderComponent($$result, "OpenSourceStat", $$OpenSourceStat, { "text": "Discord Members", "value": discordInfo.totalFormatted })} </div> </div> </div>`;
}, "/workspaces/developer-roadmap/src/components/OpenSourceBanner.astro", void 0);

const pageProgressMessage = atom(void 0);
const sponsorHidden = atom(false);
...
function PageProgress(props) {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("div", { className: "fixed left-0 top-0 z-[100] flex h-full w-full items-center justify-center bg-white bg-opacity-75", children: /* @__PURE__ */ jsxs("div", { className: "flex  items-center justify-center rounded-md border bg-white px-4 py-2 ", children: [
    /* @__PURE__ */ jsx(
      Spinner,
      {
...
function markSponsorHidden(sponsorId) {
...
function isSponsorMarkedHidden(sponsorId) {
  return Cookies.get(`${CLOSE_SPONSOR_KEY}-${sponsorId}`) === "1";
}
function PageSponsor(props) {
  ...
  const loadSponsor = async () => {
    ...
    if (currentPath === "/" || currentPath === "/best-practices" || currentPath === "/roadmaps" || currentPath.startsWith("/guides") || currentPath.startsWith("/videos") || currentPath.startsWith("/account") || currentPath.startsWith("/team")) {
      return;
    }
    const { response, error } = await httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-get-sponsor`,
      {
    ...
    if (!response?.sponsor || !response.id || isSponsorMarkedHidden(response.id)) {
      return;
    }
    ...
    window.fireEvent({
      ...
      label: response.sponsor.gaLabel || `${gaPageIdentifier} / ${response.sponsor?.company} Link`
    });
  };
  const clickSponsor = async (sponsorId2) => {
    const clickUrl = new URL(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-view-sponsor/${sponsorId2}`
    );
    ...
    setViewSponsorCookie(sponsorId2);
  };
  useEffect(() => {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: /* @__PURE__ */ jsx(X, { className: "h-5 w-5 sm:h-4 sm:w-4" })
          }
        ),
        ...
        /* @__PURE__ */ jsxs("span", { className: "flex flex-1 flex-col justify-between text-xs sm:text-sm", children: [
          /* @__PURE__ */ jsxs("span", { className: "p-[10px]", children: [
            /* @__PURE__ */ jsx("span", { className: "mb-0.5 block font-semibold", children: title }),
            /* @__PURE__ */ jsx("span", { className: "block text-gray-500", children: description })
          ] }),
          /* @__PURE__ */ jsx("span", { className: "sponsor-footer hidden sm:block", children: "Partner Content" }),
          /* @__PURE__ */ jsx("span", { className: "block pb-1 text-center text-[10px] uppercase text-gray-400 sm:hidden", children: "Partner Content" })
        ] })
      ]
    }
  );
...
function PageVisit(props) {
  ...
  useEffect(() => {
    ...
    httpPost(`${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-visit`, {
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const commitUrl = `https://github.com/kamranahmedse/developer-roadmap/commit/${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.GITHUB_SHA}`;
  const gaPageIdentifier = Astro2.url.pathname.replace(/^\//, "").replace(/\/$/, "").replace(/\//g, ":");
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="commit"${addAttribute(commitUrl, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta name="author" content="Kamran Ahmed"><meta name="keywords"${addAttribute(keywords.join(", "), "content")}>${redirectUrl && renderTemplate`<meta http-equiv="refresh"${addAttribute(`1;url=${redirectUrl}`, "content")}>`}${noIndex && renderTemplate`<meta name="robots" content="noindex">`}<meta name="viewport" content="width=device-width, user-scalable=yes, initial-scale=1.0, maximum-scale=3.0, minimum-scale=1.0"><meta http-equiv="Content-Language" content="en"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:creator" content="@kamrify"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image"${addAttribute(ogImageUrl || "https://roadmap.sh/images/og-img.png", "content")}><meta property="og:image:alt" content="roadmap.sh"><meta property="og:site_name" content="roadmap.sh"><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:type" content="website"><meta property="og:url"${addAttribute(currentPageAbsoluteUrl, "content")}><link rel="canonical"${addAttribute(canonicalUrl, "href")}><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><meta name="apple-mobile-web-app-title" content="roadmap.sh"><meta name="application-name" content="roadmap.sh"><link rel="apple-touch-icon" sizes="180x180" href="/manifest/apple-touch-icon.png"><meta name="msapplication-TileColor" content="#101010"><meta name="theme-color" content="#848a9a"><link rel="manifest" href="/manifest/manifest.json"><link rel="icon" type="image/png" sizes="32x32" href="/manifest/icon32.png"><link rel="icon" type="image/png" sizes="16x16" href="/manifest/icon16.png"><link rel="shortcut icon" href="/manifest/favicon.ico" type="image/x-icon"><link rel="icon" href="/manifest/favicon.ico" type="image/x-icon"><link rel="preconnect" href="https://www.google-analytics.com/"><link rel="preconnect" href="https://api.roadmap.sh/">${renderSlot($$result, $$slots["after-header"])}${jsonLd.length > 0 && renderTemplate(_a || (_a = __template(['<script type="application/ld+json">', "</script>"])), unescapeHTML(JSON.stringify(jsonLd.length === 1 ? jsonLd[0] : jsonLd)))}${renderHead()}</head> <body class="flex min-h-screen flex-col"> ${renderSlot($$result, $$slots["page-header"], renderTemplate` ${renderComponent($$result, "Navigation", $$Navigation, {})} `)} ${renderSlot($$result, $$slots["default"])} ${renderSlot($$result, $$slots["page-footer"], renderTemplate` ${renderComponent($$result, "OpenSourceBanner", $$OpenSourceBanner, {})} ${renderComponent($$result, "Footer", $$Footer, {})} `)} ${renderComponent($$result, "Authenticator", $$Authenticator, {})} ${renderSlot($$result, $$slots["login-popup"], renderTemplate` ${renderComponent($$result, "LoginPopup", $$LoginPopup, {})} `)} ${renderComponent($$result, "Toaster", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/workspaces/developer-roadmap/src/components/Toast", "client:component-export": "Toaster" })} ${renderComponent($$result, "CommandMenu", CommandMenu, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "/workspaces/developer-roadmap/src/components/CommandMenu/CommandMenu", "client:component-export": "CommandMenu" })} ${renderComponent($$result, "PageProgress", PageProgress, { "initialMessage": initialLoadingMessage, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "/workspaces/developer-roadmap/src/components/PageProgress", "client:component-export": "PageProgress" })} ${renderComponent($$result, "PageSponsor", PageSponsor, { "gaPageIdentifier": briefTitle || gaPageIdentifier, "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/PageSponsor", "client:component-export": "PageSponsor" })} ${renderSlot($$result, $$slots["after-footer"])} ${renderComponent($$result, "Analytics", $$Analytics, {})} ${renderComponent($$result, "PageVisit", PageVisit, { "resourceId": resourceId, "resourceType": resourceType, "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/PageVisit/PageVisit", "client:component-export": "PageVisit" })} </body></html>`;
}, "/workspaces/developer-roadmap/src/layouts/BaseLayout.astro", void 0);

export { $$AstroIcon as $, AuthenticationForm as A, httpDelete as B, GitHubIcon as G, Spinner as S, TOKEN_COOKIE_NAME as T, $$BaseLayout as a, httpPatch as b, cn as c, decodeToken as d, $$Popup as e, httpPost as f, useKeydown as g, httpGet as h, getOpenAIKey as i, deleteOpenAIKey as j, isLoggedIn as k, setAIReferralCode as l, $$LoginPopup as m, getUser as n, GoogleIcon as o, pageProgressMessage as p, sponsorHidden as q, removeAuthToken as r, saveOpenAIKey as s, AccountTerms as t, useOutsideClick as u, visitAIRoadmap as v, httpPut as w, $$Footer as x, setAuthToken as y, GroupIcon as z };
