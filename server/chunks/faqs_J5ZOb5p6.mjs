...
}, "/workspaces/developer-roadmap/src/data/roadmaps/frontend/faqs.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/data/roadmaps/frontend/faqs.astro";
const $$url = undefined;
