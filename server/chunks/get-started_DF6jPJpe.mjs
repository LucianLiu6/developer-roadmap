...
import { ExternalLink, Globe2, ServerCog, GraduationCap, Blocks, Braces, Server, Cloud, Smartphone, Bot, MessageCircleCode, ShieldHalf, Workflow, PenSquare, Gamepad2, FolderKanban, Component, Waypoints, CheckSquare } from 'lucide-react';
...
function RoadmapCard(props) {
  ...
  if (isUpcoming) {
    return /* @__PURE__ */ jsxs("div", { className: "group relative block rounded-xl border border-gray-300 bg-gradient-to-br from-gray-100 to-gray-50 p-5 overflow-hidden", children: [
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "flex-grow bg-gray-200/70 p-4 sm:p-5 text-sm text-gray-500", children: description }),
        ...
        secondaryDescription && /* @__PURE__ */ jsx("p", { className: "flex-grow bg-gray-200/70 p-4 sm:p-5 text-sm text-gray-500", children: secondaryDescription })
      ]
    }
  );
}
...
function RoleRoadmaps(props) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-b from-gray-100 to-white py-5 sm:py-8 md:py-12", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
...
const $$GetStarted = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Developer Roadmaps", "description": "Step by step guides and paths to learn different tools or technologies", "permalink": "/roadmaps" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="bg-gradient-to-b from-gray-200 to-white py-4 sm:py-8 md:py-12"> <div class="container"> <div class="text-left"> ${renderComponent($$result2, "SectionBadge", SectionBadge, { "title": "Beginner Roadmaps" })} </div> <div class="my-3 text-left md:my-5"> <h2 class="mb-0 text-xl font-semibold sm:mb-1 sm:text-3xl">
...
Learning to code can be overwhelming, here are some tips to help you
  ...
  ], "description": "How about mastering the language of the web: JavaScript? or maybe TypeScript?", "secondaryRoadmaps": [
    {
  ...
  ], "secondaryDescription": "Or perhaps improve your database skills?" })} ` })} ${renderComponent($$result2, "RoleRoadmaps", RoleRoadmaps, { "badge": "DevOps Engineer", "title": "DevOps or a Wanna-be DevOps Engineer?", "description": "Explore the general DevOps roadmap or dive into a specific technology like Docker, Kubernetes etc" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Server, "title": "DevOps", "link": "/devops", "description": "Learn all you need to know to become a DevOps Engineer." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Cloud, "title": "AWS", "link": "/aws", "description": "Learn all you need to know to become an AWS Engineer." })} ${renderComponent($$result3, "RoadmapMultiCard", RoadmapMultiCard, { "roadmaps": [
  ...
  ], "description": "Or learn a cross-platform framework?" })} ` })} ${renderComponent($$result2, "RoleRoadmaps", RoleRoadmaps, { "badge": "AI and Machine Learning", "title": "Are you an AI or Machine Learning enthusiast?", "description": "How about diving into the AI or Machine Learning roadmaps?" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Bot, "title": "AI and Data Science", "link": "/ai-data-scientist", "description": "Learn all you need to know to become an AI or Data Scientist." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Bot, "title": "Data Analyst", "link": "/data-analyst", "description": "Learn all you need to know to become a Data Analyst." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": MessageCircleCode, "title": "Prompt Engineering", "link": "/prompt-engineering", "description": "Learn how to write better prompts for GPT-* and other language models." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Bot, "icon2": ServerCog, "title": "MLOps", "link": "/mlops", "description": "Learn how to deploy and manage machine learning models." })} ` })} ${renderComponent($$result2, "RoleRoadmaps", RoleRoadmaps, { "badge": "More Roles", "title": "Fancy something else?", "description": "Explore the following roadmaps about UX, Game Development, Software Architect and more" }, { "default": ($$result3) => renderTemplate` <div class="flex flex-col justify-start gap-3"> ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": ShieldHalf, "title": "Cyber Security", "link": "/cyber-security", "description": "Learn to become a Cyber Security Expert." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Workflow, "title": "UX Designer", "link": "/ux-design", "description": "Learn all you need to know to become a UX Designer." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": PenSquare, "title": "Blockchain", "link": "/blockchain", "description": "Learn all you need to know to become a Blockchain Developer." })} </div> <div class="flex flex-col justify-start gap-3"> ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Gamepad2, "title": "Game Development", "link": "/game-developer", "description": "Learn all you need to know to become a Game Developer." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": PenSquare, "title": "Technical Writer", "link": "/technical-writer", "description": "Learn all you need to know to become a Technical Writer." })} </div> <div class="flex flex-col justify-start gap-3"> ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": FolderKanban, "title": "Product Manager", "link": "/product-manager", "description": "Learn all you need to know to become a Project Manager." })} ${renderComponent($$result3, "RoadmapCard", RoadmapCard, { "icon": Component, "title": "Software Architect", "link": "/software-architect", "description": "Learn all you need to know to become a Software Architect." })} </div> ` })} <div class="container"> <div class="-mt-5 mb-12 rounded-3xl bg-black p-5"> <h2 class="mb-0.5 text-xl font-semibold text-white sm:mb-1 sm:text-2xl">
There is more!
</h2> <p class="text-sm text-gray-400 sm:text-base">
We have a lot more content for you to explore.
</p> <div class="my-4 grid grid-cols-1 gap-2 sm:my-5 sm:grid-cols-2 sm:gap-3 md:grid-cols-3"> <a href="/roadmaps" class="flex-grow rounded-lg bg-gradient-to-br from-gray-800 to-gray-700 p-4 text-sm text-white transition-all hover:from-gray-700 hover:to-gray-700 sm:text-base"> ${renderComponent($$result2, "Waypoints", Waypoints, { "className": "mb-3 h-5 w-5 text-gray-500 sm:mb-2" })}
Explore all Roadmaps
</a> <a href="/best-practices" class="flex-grow rounded-lg bg-gradient-to-br from-gray-800 to-gray-700 p-4 text-sm text-white transition-all hover:from-gray-700 hover:to-gray-700 sm:text-base"> ${renderComponent($$result2, "CheckSquare", CheckSquare, { "className": "mb-3 h-5 w-5 text-gray-500 sm:mb-2" })}
Explore Best Practices
</a> <a href="/questions" class="flex-grow rounded-lg bg-gradient-to-br from-gray-800 to-gray-700 p-4 text-sm text-white transition-all hover:from-gray-700 hover:to-gray-700 sm:text-base"> ${renderComponent($$result2, "CheckSquare", CheckSquare, { "className": "mb-3 h-5 w-5 text-gray-500 sm:mb-2" })}
Explore Questions
...
}, "/workspaces/developer-roadmap/src/pages/get-started.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/get-started.astro";
