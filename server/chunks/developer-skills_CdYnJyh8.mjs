...
}, "/workspaces/developer-roadmap/src/pages/java/developer-skills.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/java/developer-skills.astro";
const $$url = "/java/developer-skills";
