...
import 'kleur/colors';
import { k as isLoggedIn, c as cn, a as $$BaseLayout } from './BaseLayout_CyQdLUYI.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { CheckCircle, SquareIcon, Shrub, Barcode, UserRoundPlus, PieChart, AlertTriangle, BookOpenIcon, Copy } from 'lucide-react';
...
function TeamPricing() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "border-t py-4 sm:py-8 md:py-12", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 sm:flex-row sm:gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-grow flex-col items-center justify-center rounded-md border border-gray-300 py-8", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            alt: "waving hand",
...
const $$Teams = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Roadmaps for teams", "permalink": "/teams" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TeamHeroBanner", TeamHeroBanner, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/TeamMarketing/TeamHeroBanner", "client:component-export": "TeamHeroBanner" })} ${renderComponent($$result2, "TeamTools", TeamTools, {})} ${renderComponent($$result2, "TeamDemo", TeamDemo, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/TeamMarketing/TeamDemo", "client:component-export": "TeamDemo" })} ${renderComponent($$result2, "TeamPricing", TeamPricing, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/TeamMarketing/TeamPricing", "client:component-export": "TeamPricing" })} ` })}`;
}, "/workspaces/developer-roadmap/src/pages/teams.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/teams.astro";
const $$url = "/teams";
