...
import { u as useTeamId, $ as $currentTeam, T as TeamDropdown } from './TeamDropdown_CxJZJkhn.mjs';
import { useRef, useState, useEffect } from 'react';
import { useStore } from '@nanostores/react';
import './use-toast_BupOxZu-.mjs';
import { u as useOutsideClick, g as useKeydown, f as httpPost, z as GroupIcon } from './BaseLayout_CyQdLUYI.mjs';
import { C as CheckIcon } from './CheckIcon_B3c1RSNy.mjs';
import { BarChart2, MapIcon, MessageCircle } from 'lucide-react';

new Proxy({"src":"/_astro/chat.D-nhwTma.svg","width":24,"height":24,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/developer-roadmap/src/icons/chat.svg";
							}
...
function SubmitFeedbackPopup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpPost(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-submit-team-feedback/${teamId}`,
      {
          ...
          /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: sidebarLinks.map((sidebarLink) => {
            ...
            return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
              "a",
              {
                ...
                children: /* @__PURE__ */ jsxs("span", { className: "flex flex-grow items-center justify-between", children: [
