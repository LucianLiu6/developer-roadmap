...
const $$DeveloperTools = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": replaceVariables(guideData.seo.title), "description": replaceVariables(guideData.seo.description), "permalink": `/backend/developer-tools`, "canonicalUrl": guideData.canonicalUrl, "ogImageUrl": ogImageUrl }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "GuideHeader", $$GuideHeader, { "guide": guide })} ${renderComponent($$result2, "GuideContent", $$GuideContent, { "guide": guide })} ` })}`;
}, "/workspaces/developer-roadmap/src/pages/backend/developer-tools.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/backend/developer-tools.astro";
const $$url = "/backend/developer-tools";

export { $$DeveloperTools as default, $$file as file, $$url as url };
