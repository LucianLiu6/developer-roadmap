...
import { c as cn, u as useOutsideClick, p as pageProgressMessage, b as httpPatch, f as httpPost, h as httpGet } from './BaseLayout_CyQdLUYI.mjs';
...
import { U as UploadProfilePicture } from './UploadProfilePicture_C8TU1c7H.mjs';
...
function VisibilityDropdown(props) {
  ...
  async function updateProfileVisibility(visibility2) {
    ...
    const { error } = await httpPatch(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-update-public-profile-visibility`,
      {
...
function ProfileUsername(props) {
  ...
  const checkIsUnique = async (username2) => {
    ...
    setIsLoading(true);
    const { response, error } = await httpPost(`${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-check-is-unique-username`, {
      username: username2
    });
    if (error || !response) {
      setIsUnique(null);
          ...
          !isLoading && /* @__PURE__ */ jsxs("span", { className: "flex items-center", children: [
            ...
            currentUsername !== username && username && isUnique && /* @__PURE__ */ jsxs("span", { className: "text-xs text-green-600", children: [
              ...
              /* @__PURE__ */ jsxs(
                "a",
                {
                  href: `${"https://roadmap.sh"}/u/${username}`,
                  target: "_blank",
                  className: "ml-0.5 rounded-md border border-purple-500 px-1.5 py-0.5 text-xs font-medium text-purple-700 transition-colors hover:bg-purple-500 hover:text-purple-800 hover:text-white",
                  children: [
                    "roadmap.sh/u/",
                    username
                  ]
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative grow", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            ...
            onKeyDown: (e) => {
              const keyCode = e.key;
              const validKey = /^[a-zA-Z0-9]*$/.test(keyCode) && username.length < 10;
              if (!validKey && !["Backspace", "Delete", "ArrowLeft", "ArrowRight"].includes(
                keyCode
              )) {
                e.preventDefault();
              }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative mb-5 rounded-lg bg-yellow-200 px-3 py-3 text-sm text-yellow-800", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "my-3 ml-2 flex flex-col gap-1 sm:ml-3", children: ideas.map((idea) => /* @__PURE__ */ jsxs(
      "p",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "relative top-[3px] h-3.5 w-3.5 flex-shrink-0 stroke-[2.5] sm:top-0" }),
...
function UpdatePublicProfileForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error } = await httpPatch(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-update-public-profile-config`,
      {
        isAvailableForHire,
        isEmailVisible,
        profileVisibility,
  ...
  const loadProfileSettings = async () => {
    ...
    const { error, response } = await httpGet(
      `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-get-profile-settings`
    );
    if (error || !response) {
      setIsLoading(false);
      toast.error(error?.message || "Something went wrong");
  ...
  const loadProfileRoadmaps = async () => {
    setIsLoading(true);
    const { error, response } = await httpGet(`${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-get-profile-roadmaps`);
    if (error || !response) {
      setIsLoading(false);
      toast.error(error?.message || "Something went wrong");
      return;
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-8 flex flex-col justify-between gap-2 sm:mb-1 sm:flex-row", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-grow flex-row items-center gap-2 sm:items-center", children: [
    ...
    /* @__PURE__ */ jsx(
      UploadProfilePicture,
      {
        ...
        avatarUrl: avatar ? `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_AVATAR_BASE_URL}/${avatar}` : "/images/default-avatar.png"
      }
    ),
...
const $$UpdateProfile = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AccountLayout", $$AccountLayout, { "title": "Update Profile", "noIndex": true, "initialLoadingMessage": "Loading profile" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AccountSidebar", $$AccountSidebar, { "activePageId": "profile", "activePageTitle": "Profile" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "UpdatePublicProfileForm", UpdatePublicProfileForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/workspaces/developer-roadmap/src/components/UpdateProfile/UpdatePublicProfileForm", "client:component-export": "UpdatePublicProfileForm" })} ` })} ` })}`;
}, "/workspaces/developer-roadmap/src/pages/account/update-profile.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/account/update-profile.astro";
const $$url = "/account/update-profile";

export { $$UpdateProfile as default, $$file as file, $$url as url };
