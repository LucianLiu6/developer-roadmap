...
}, "/workspaces/developer-roadmap/src/pages/devops/devops-vs-sre.astro", void 0);

const $$file = "/workspaces/developer-roadmap/src/pages/devops/devops-vs-sre.astro";
const $$url = "/devops/devops-vs-sre";

export { $$DevopsVsSre as default, $$file as file, $$url as url };
