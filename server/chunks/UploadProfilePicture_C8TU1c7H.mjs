...
import { r as removeAuthToken } from './BaseLayout_CyQdLUYI.mjs';
...
function UploadProfilePicture(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (type === "avatar") {
      res = await fetch(
        `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-upload-profile-picture`,
        {
          method: "POST",
          body: formData,
          credentials: "include"
      ...
      res = await fetch(
        `${{"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://roadmap.sh/", "ASSETS_PREFIX": undefined}.PUBLIC_API_URL}/v1-upload-team-logo/${teamId}`,
        {
          method: "POST",
          body: formData,
          credentials: "include"
